...
'''
    ...
    16 !=  # Comparison Operators  
    17
    a_list.append  # Methods 
    18
    a_list.extend  # Methods 
    19
    a_list.insert  # Methods 
    20
    a_list.remove  # Methods 
    21
    a_list.pop  # Methods 
    22
    a_list.reverse  # Methods 
    23
    a_list.sort  # Methods 
    24
    a_seq.index  # Methods 
...
The sort is guaranteed to be stable. Thus, when multiple elements have the same key, their original order is preserved.
    ...
    Position = a_list.pop()
    Reverse
    Items in List = a_list.reverse()
    Sort
    Items in List in Place = a_list.sort()
    # ------------------------------------------------------- #
    List
    Constants = […]
    ...
    It is often
    used in
    for loops, as illustrated in the last example above.It provides a mechanism for looping a specific number of iterations.
    # ------------------------------------------------------- #
    Syntax:
    a_list.append(x)
    Examples:
    ...
    mistake is to
    confuse
    a_list.append(x) and a_list.extend(x).As
    shown in the
    last
    example
    above, the
    ...
    By
    default or when
    rev_bool is False, the
    elements
    are in ascending
    order.When
    rev_bool is True, the
    elements
    are in descending
    order.(Bug: It
    reverses
    when
    rev_bool is False, too.) If
    the
    elements
    are
    of

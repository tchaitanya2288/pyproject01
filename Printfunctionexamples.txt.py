...
a
variable in
hexadecimal(hex()), octal(oct()), ordinal(ord()), string(chr()) or unicode
string(unichr())
...
treats
received
data as string if it is included
in quotes
'' or "", otherwise
...
Python
3, raw_input()
function is deprecated.Further, received
data is always
treated as string
"""*******************************************************************"""
# In Python 2:
...
x
it
's function and it uses parantheses like : print() and its mandatory.

Example:

print
"Hello Python Developers"  # is acceptable in Python 2
...
Example:
print
a,  # Trailing comma suppresses newline in Python 2
...
Old: print
x,  # Trailing comma suppresses newline
